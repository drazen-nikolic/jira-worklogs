...
public class WorkLogCsvExportAdapterTest {
    ...
    private static final String USER_EMAIL = "username@email.com";
    ...
    public void setUp() {
        ...
        when(workLogManagerPort.findWorkLogsForUserInPeriod(anyString(), any(), any())).thenReturn(workLogCollection);
    ...
    public void exportWorkLogsForUserInPeriod_ShouldReturnNull_WhenNoWorkLogEntriesExist() {
        ...
        when(workLogManagerPortWithNoResults.findWorkLogsForUserInPeriod(anyString(), any(), any())).thenReturn(Collections.emptyList());
        workLogCsvExportAdapter = new WorkLogCsvExportAdapter(workLogManagerPortWithNoResults);

        // when
        File csvFile = workLogCsvExportAdapter.exportWorkLogsForUserInPeriod(USER_DISPLAY_NAME, START_DATE, END_DATE);
    ...
    public void exportWorkLogsForUserInPeriod_ShouldReturnCSVFile_WhenWorkLogEntriesExist() throws Exception {
        ...
        assertThat(workLogRecord.next(), is(USER_EMAIL));
